    ...
    switch (instr.op)
    {
            ...
            for(auto j:globalvs){
				...
				if(op1.name[0]=='0'&&op1.name[1]=='b'){
            		...
            		for(int i=2;i<=op1.name.size()-1;i++){
						...
						else p=p+q*stoi(to_string(op1.name[i]-'0'));
					}
					op1.name=to_string(p);
				}
        ...
        case ir::Operator::add:{
			...
			for(ir::Operand operand:{op1,op2,des
                ...
                else if(ci==2)insts.push_back(rv::rv_inst(rv::rvOPCODE::LW, rv::rvREG::X12,rv::rvREG::X2, arr));
                else{
        ...
        case ir::Operator::fadd:{
			...
			for(ir::Operand operand:{op1,op2,des
                ...
                else if(ci==2) insts.push_back(rv::rv_inst(rv::rvOPCODE::FLW, rv::rvFREG::F12,rv::rvREG::X10, 0));
                else{
                ...
                else if(ci==2)insts.push_back(rv::rv_inst(rv::rvOPCODE::FLW, rv::rvFREG::F12,rv::rvREG::X2, arr));
                else{
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::FADD, rv::rvFREG::F10, rv::rvFREG::F11, rv::rvFREG::F12));
                	int arr1=stack_.find_operand(operand);
			 ...
			 if(op2.type==ir::Type::FloatLiteral){
				...
				if(op2.name[0]=='0'&&op2.name[1]=='b'){
            		...
            		for(int i=2;i<=op2.name.size()-1;i++){
						...
						else p=p+q*stoi(to_string(op2.name[i]-'0'));
					}
					op2.name=to_string(p);
				}
        ...
        case ir::Operator::_goto:{
        	...
        	int flag=0;
                ...
                else{int arr=stack_.find_operand(op1);
                        insts.push_back(rv::rv_inst(rv::rvOPCODE::LW, rv::rvREG::X10, rv::rvREG::X2, arr));
                }
        }
		...
		case ir::Operator::store:{
			...
			if(ci==2&&flag2==1)
                ...
                else if(ci==2) insts.push_back(rv::rv_inst(rv::rvOPCODE::LW, rv::rvREG::X12,rv::rvREG::X11, 0));
                else{
           ...
           insts.push_back(rv::rv_inst(rv::rvOPCODE::ADD, rv::rvREG::X11, rv::rvREG::X11, rv::rvREG::X10));
			...
			if(ci==2&&flag2==1)
                ...
                else if(ci==2) insts.push_back(rv::rv_inst(rv::rvOPCODE::FLW, rv::rvFREG::F10,rv::rvREG::X11, 0));
                else{
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::ADD, rv::rvREG::X11, rv::rvREG::X11, rv::rvREG::X10));
                insts.push_back(rv::rv_inst(rv::rvOPCODE::FSW, rv::rvREG::X11, 0, rv::rvFREG::F10));
				}
                ...
                insts.push_back(rv::rv_inst(rv::rvOPCODE::LW,rv::rvREG::X10, rv::rvREG::X2,arr));
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::LI,rv::rvREG::X12, 4));
				insts.push_back(rv::rv_inst(rv::rvOPCODE::MUL,rv::rvREG::X10, rv::rvREG::X10, rv::rvREG::X12));}
                else if(ci==2)insts.push_back(rv::rv_inst(rv::rvOPCODE::FLW, rv::rvFREG::F10,rv::rvREG::X2, arr));
                else{
        ...
        case ir::Operator::load:{
			...
			if(ci==1&&flag1==1)
                ...
                else if(ci==3) insts.push_back(rv::rv_inst(rv::rvOPCODE::SW, rv::rvREG::X11, 0,rv::rvREG::X12));
                else{
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::ADD, rv::rvREG::X11, rv::rvREG::X11, rv::rvREG::X10));
                ...
                insts.push_back(rv::rv_inst(rv::rvOPCODE::LW,rv::rvREG::X10, rv::rvREG::X2,arr));
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::LI,rv::rvREG::X12, 4));
				insts.push_back(rv::rv_inst(rv::rvOPCODE::MUL,rv::rvREG::X10, rv::rvREG::X10, rv::rvREG::X12));}
                else if(ci==3)insts.push_back(rv::rv_inst(rv::rvOPCODE::SW, rv::rvREG::X2, arr,rv::rvREG::X12));
                else{
           ...
           insts.push_back(rv::rv_inst(rv::rvOPCODE::ADD, rv::rvREG::X11, rv::rvREG::X11, rv::rvREG::X10));
			...
			if(ci==1&&flag1==1)
                ...
                else if(ci==3) insts.push_back(rv::rv_inst(rv::rvOPCODE::FSW, rv::rvREG::X11, 0,rv::rvFREG::F12));
                else{
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::ADD, rv::rvREG::X11, rv::rvREG::X11, rv::rvREG::X10));
                ...
                insts.push_back(rv::rv_inst(rv::rvOPCODE::LW,rv::rvREG::X10, rv::rvREG::X2,arr));
                	insts.push_back(rv::rv_inst(rv::rvOPCODE::LI,rv::rvREG::X12, 4));
				insts.push_back(rv::rv_inst(rv::rvOPCODE::MUL,rv::rvREG::X10, rv::rvREG::X10, rv::rvREG::X12));}
                else if(ci==3)insts.push_back(rv::rv_inst(rv::rvOPCODE::FSW, rv::rvREG::X2, arr,rv::rvFREG::F12));
                else{
...
for(int i=0; i < function.ParameterList.size(); i++){
    ...
    for(int i = 0; i < all_; i++) al.push_back(insts[i]);
    ...
    for (auto inst:al){ fout << inst.draw();}
